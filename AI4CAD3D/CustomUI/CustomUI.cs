...
namespace CustomUISample
{
    ...
    public class CustomUI : IFrameworkCallback, IDeviceCreation
    {
        ...
        public struct Nokta
        {
            ...
            public float Y;
            public float Z;
            public Nokta(float pX,float pY,float pZ)
            {
                X=pX;
                Y=pY;
                Z=pZ;
        ...
        // camera matrix Variable
        public float TranX;
        public float TranY;
        public float TranZ=-6;
        public float AngleX;
        public float AngleY;
        public float AngleZ;
        public float FOV=60;
        ...
        //art alan rengi
        public System.Drawing.Color MyClearColor = System .Drawing .Color .Black;

        //vertex buffer variables
        private int SiradakiVerts, KoseNoktaAdet, PrimCOunt;
        private VertexBuffer vertexBuffer = null; //directx için yüzey bufferý
        private CustomVertex.PositionNormalColored[] verts; // uzaydaki vektör
        ...
        {
            //Graphich Init
            e.Device.PresentationParameters.Windowed = true;
            e.Device.PresentationParameters.SwapEffect = SwapEffect.Discard;
            e.Device.PresentationParameters.EnableAutoDepthStencil = true;
            e.Device.PresentationParameters.AutoDepthStencilFormat = DepthFormat.D16;
        ...
        /// <summary>
        /// Kamera matrislerinin setubu
        /// </summary>
        private void SetupMatrices()
        {
            Matrix WorldTransform,Xrot,Yrot,Zrot,Tran;
            ...
            this.sampleFramework.Device.Transform.View = WorldTransform;
            this.sampleFramework.Device.Transform.Projection = Matrix.PerspectiveFovRH(ToRadians(FOV), 1.0F, 0.01F, 10000.0F);
        }
        ...
        public void OnFrameRender(Device device, double appTime, float elapsedTime)
        {
            ...
            if (KoseNoktaAdet == 0) return; //köþe nokta yoksa çýk
        ...
        private void DrawUcgen(Nokta[] Nokta, System .Drawing.Color MyColor)
        {
            int UpVector = 1;
            float[] X = new float[3];
            float[] Y = new float[3];
        ...
        private void RenderText()
        {
            ...
            txtHelper.SetForegroundColor(System.Drawing.Color.Lime);
        ...
        public void InitializeApplication()
        {
            int y = 10;
            // Initialize the HUD
            Button fullScreen = hud.AddButton(ToggleFullscreen,"Tam Ekran", 35, y, 125,22);
